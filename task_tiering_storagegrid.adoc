...
.. *Server*: Enter the FQDN of the StorageGRID server, choose the port that ONTAP should use for HTTPS communication with StorageGRID, and enter the access key and secret key for an AWS account that has the required S3 permissions.
