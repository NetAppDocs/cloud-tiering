...
You can use Cloud Tiering to tier data from NAS volumes. In the next release, you will be able to use Cloud Tiering with volumes that clients access using SAN protocols.
