...
Cloud Central needs link:task_preparing.html#preparing-aws-s3-for-data-tiering[permissions to deploy the Service Connector] and link:task_preparing.html#setting-up-an-aws-account-for-the-service-connector[permissions that it configures your ONTAP clusters to use].
