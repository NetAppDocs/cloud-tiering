...
If the health for a cluster is failed, you can remove it from the dashboard to focus on the operational clusters.
...
. . From the *Cluster Dashboard*, click menu icon for a cluster and select *Remove Cluster*.
+
