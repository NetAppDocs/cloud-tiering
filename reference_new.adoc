...
NOTE: We're planning to add Cloud Tiering to the Azure Marketplace as soon we can.

=== Support for FlexGroup volumes

You can now tier inactive data from FlexGroup volumes to object storage. Setup works the same as any other volume.
