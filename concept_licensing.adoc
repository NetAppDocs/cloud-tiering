...
* If you tier more data than allowed by your FabricPool license, then data tiering continues through your PAYGO subscription.
+
For example, if you have a 10 TB license, all capacity beyond the 10 TB is charged through the PAYGO subscription.

You won't be charged from your PAYGO subscription during your free trial or if you haven't exceeded your FabricPool license.
