...
[.lead]
Based on NetApp FabricPool technology, Cloud Tiering identifies infrequently-used data in your ONTAP cluster and automatically and seamlessly moves that data to lower-cost object storage in the cloud.
